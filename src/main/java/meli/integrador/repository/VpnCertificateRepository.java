...
public interface VpnCertificateRepository extends JpaRepository<VpnCertificate, String> {
    ...
    /**
     * Encontra todos os certificados de um usuário, ordenados por data de emissão
     ...
     * @param certificateId ID do certificado
     * @param userId        ID do usuário
     * @return true se o certificado existir e pertencer ao usuário, false caso
     *         contrário
     */
     ...
     * @param userId  ID do usuário
     * @param revoked Status de revogação a ser filtrado
     * @return Lista de certificados do usuário com o status de revogação
     *         especificado
     */
