...
public class UserRequest {
    ...
    @NotBlank(groups = { ValidationGroups.CreateUser.class,
            ValidationGroups.UpdateUser.class }, message = "{user.username.required}")
    ...
    @NotBlank(groups = { ValidationGroups.CreateUser.class,
            ValidationGroups.UpdateUser.class }, message = "{user.fullname.required}")
    ...
    @NotBlank(groups = { ValidationGroups.CreateUser.class,
            ValidationGroups.UpdateUser.class }, message = "{user.email.required}")
    ...
    @Pattern(regexp = "^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#&()–[{}]:;',?/*~$^+=<>]).{8,}$", message = "{user.password.weak}", groups = {
            ValidationGroups.CreateUser.class, ValidationGroups.UpdateUser.class })
    @Schema(description = "Senha do usuário. Deve conter pelo menos 8 caracteres, incluindo letras maiúsculas, minúsculas, números e caracteres especiais.", example = "Senha@123", requiredMode = Schema.RequiredMode.REQUIRED, accessMode = Schema.AccessMode.WRITE_ONLY)
    ...
    @Schema(description = "Indica se o usuário tem permissão para usar a VPN", example = "false", defaultValue = "false")
